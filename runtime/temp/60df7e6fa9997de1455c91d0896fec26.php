<?php /*a:4:{s:66:"/www/wwwroot/tool.528sq.cn/application/index/view/index/whois.html";i:1696135592;s:61:"/www/wwwroot/tool.528sq.cn/application/index/view/header.html";i:1696136048;s:58:"/www/wwwroot/tool.528sq.cn/application/index/view/nav.html";i:1696088816;s:61:"/www/wwwroot/tool.528sq.cn/application/index/view/footer.html";i:1696088816;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    ...
    <title><?php echo htmlentities(app('config')->get('web.whois.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.whois.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.whois.description')); ?>"/>
            ...
            <div class="accordion" id="accordion2">
                <div class="accordion-group">
                    <ul class="nav nav-tabs hbflag">
                        ...
                        <li role="presentation" class="active"><a href="/whois/"> Whois查询工具</a></li>
                    ...
                    <div class="panel">
                        <form id="form1" class="form-horizontal" method="post">
                            <div class="input-group mb5" style="width:85%"><input class="form-control" type="text"
                                                                                  name="whois" id="whois" value="<?php echo htmlentities($url); ?>"
                                                                                  placeholder="输入域名，如:<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"/><span
                                    class="input-group-btn"><button class="btn btn-success" type="submit" id="get_remote">查询WHOIS</button></span>
                            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        WHOIS查询结果，域名 <span class="greentag"><?php echo htmlentities($url); ?></span> WHOIS信息
                                    </h3>
                                </div>
                                <table class="table table-bordered table-striped">
                                    <?php foreach($domain as $name=>$value): ?>
                                    <tr><td><span class="lx_name"><?php echo htmlentities($name); ?></span><span class="lx_value"><?php if(is_array($value)): foreach($value as $value2): ?><?php echo htmlentities($value2); ?><br/><?php endforeach; else: ?><?php echo htmlentities($value); ?><?php endif; ?></span></td></tr>
                                    <?php endforeach; ?>
                                </table>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12"><pre style="display: block;"><code id="result" class="hljs"></code></pre>
                                </div>
                            </div>
                            <?php endif; ?>
                ...
                <div class="alert alert alert-success alert-dismissible"><h4>Whois查询</h4>
                    <p>Whois
                        简单来说，就是一个用来查询域名是否已经被注册，以及注册域名的详细信息的数据库（如域名所有人、域名注册商、域名注册日期和过期日期等）。通过域名Whois服务器查询，可以查询域名归属者联系方式，以及注册和到期时间,可以用
                        <?php echo htmlentities($_SERVER['HTTP_HOST']); ?>/whois 访问！</p>
                    ...
                    <p>(3) 过期后48天后仍未续费的，域名将随时被删除。</p></div>
...
<?php if($url): ?><script>hightout(<?php echo $whois; ?>);</script><?php endif; ?>
