<?php /*a:4:{s:67:"/www/wwwroot/tool.528sq.cn/application/index/view/index/chaicp.html";i:1696135592;s:61:"/www/wwwroot/tool.528sq.cn/application/index/view/header.html";i:1696136048;s:58:"/www/wwwroot/tool.528sq.cn/application/index/view/nav.html";i:1696088816;s:61:"/www/wwwroot/tool.528sq.cn/application/index/view/footer.html";i:1696088816;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    ...
    <title><?php echo htmlentities(app('config')->get('web.chaicp.title')); ?></title>
    <meta name="applicable-device" content="pc,mobile"/>
    <meta http-equiv="Cache-Control" content="no-transform"/>
    <meta http-equiv="Cache-Control" content="no-siteapp"/>
    <meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.chaicp.keywords')); ?>"/>
    <meta name="description" content="<?php echo htmlentities(app('config')->get('web.chaicp.description')); ?>"/>
                    ...
                    <div class="panel">
                        <form id="form1" class="form-horizontal" method="post">
                            <div class="input-group mb5" style="width:85%"><input class="form-control" type="text"
                                                                                  name="icp" id="icp" value="<?php echo htmlentities($url); ?>"
                                                                                  placeholder="请输入您要查询的域名，如：<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>"/><span
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        ICP备案查询结果，域名 <span class="greentag"><?php echo htmlentities($url); ?></span> ICP备案信息
                                    </h3>
                                </div>
                                    <table class="table table-bordered table-striped">
                                        <?php if($code!='200'): ?>
                                        <tr><td><font color="red"><?php echo htmlentities($icp['msg']); ?></font></td></tr>
                                        <?php else: foreach($icp as $name=>$value): ?>
                                            <tr><td><span class="lx_name"><?php echo htmlentities($name); ?></span><span class="lx_value"><?php echo htmlentities($value); ?></span></td></tr>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
                                    </table>
                            </div>
